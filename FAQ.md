...
## 1️⃣6️⃣ 如果iOS收集不到数据显示报错，怎么解决 ？

* 插拔 USB 重新连接，多次尝试。
* 对于 iOS 17+：确保已安装 `py-ios-device>=1.0.0`
* 对于 iOS 12-16：如使用 tidevice，部分代码经过二次开发，不能安装最新版。
...
- Android: 6.0+ (已测试至 Android 16)
- iOS: 12.0+ (py-ios-device 支持 iOS 26)
